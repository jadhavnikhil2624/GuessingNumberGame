...
public class ATM {
    public static void main(String[] args) {
        ...
        Bank theBank = new Bank("Central Bank Of India");
        User aUser = theBank.addUser("Nikhil", "Jadhav", "2624");
    ...
    public static void transferFunds(User theUser, Scanner sc) {
        ...
        theUser.addActTransaction(fromAct, -1 * amount,
                String.format("Transfer to account " + theUser.getActUUID(toAct)));
